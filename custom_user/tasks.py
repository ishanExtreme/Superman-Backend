...
def send_message(self, user_id):
    ...
    message = f"""
Hi, {user.get_username()} you have total of {pending_tasks_today} tasks expiring today and {pending_tasks_tomorrow} expiring tomorrow. Type *My Tasks* to know more.
    """
...
def delete_due_tasks():
    ...
    for user in users:
        ...
        Task.objects.filter(due_date__lte=date.today() -
                            timedelta(days=2), stage=stage.id).delete()
