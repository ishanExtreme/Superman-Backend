...
*5. Show all complete/incomplete tasks:*_List all complete/incomplete tasks_
    ...
    ("stage" not in message or "stages" not in message)):
        return show_all_boards(token)
    
    # Create a new board
    if("create" in message and "board" in message and "stage" not in message):
    ...
    if("create" in message and "stage" in message):
    ...
    # list all tasks
    if("list" in message and ("tasks" or "task") in message):
